...
public class OrderPersistenceEntityTestDataBuilder {
    ...
    public static OrderItemPersistenceEntity.OrderItemPersistenceEntityBuilder entityBuilder() {
    ...
    public static OrderItemPersistenceEntity.OrderItemPersistenceEntityBuilder entityBuilderAlt() {
        return OrderItemPersistenceEntity.builder()
                .id(IdGenerator.generateTSID().toLong())
