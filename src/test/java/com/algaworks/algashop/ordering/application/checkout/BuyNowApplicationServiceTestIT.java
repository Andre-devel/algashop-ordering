...
@SpringBootTest
@Transactional
class BuyNowApplicationServiceTestIT {
    ...
    public void shouldBuyNow() {
        ...
        Mockito.when(shippingCostService.calculate(Mockito.any(ShippingCostService.CalculationRequest.class))).thenReturn(new ShippingCostService.CalculationResult(
                new Money("10.00"),
